...
impl YTransaction {
    ...
    /// yrs v1 encoding. State vector is a compact representation of updates performed on a given
    ...
    /// document. This method assumes that a payload maintains yrs v1 encoding format.
    ///
    /// Example:
    ///
    /// ```python
